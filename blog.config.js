...
const BLOG = {
  ...
  VATAR: '/avatar-terry80s.png', // 个人头像 默认取public目录下的avatar.png
  ...
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/avatar-terry80s.PNG', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
