...
const SideBarDrawer = ({ post, cRef, tags, slot, categories, currentCategory }) => {
  ...
  return <div id='sidebar-wrapper' className='hidden'>
    <div id='sidebar-drawer' className='-ml-80 bg-white dark:bg-sky-900 flex flex-col duration-300 fixed h-full left-0 overflow-y-scroll scroll-hidden top-0 z-40'>
